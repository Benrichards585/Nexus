/**
 * MODULE TEMPLATE — AIAssist.jsx
 *
 * Provides two AI capabilities:
 *   1. Extract structured data from pasted text (e.g. meeting notes, emails)
 *   2. Generate insights/recommendations from existing data
 *
 * Copy this file and update the prompts, field mappings, and labels to
 * match your module's domain.
 */
