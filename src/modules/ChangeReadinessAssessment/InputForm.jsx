/**
 * CHANGE READINESS ASSESSMENT — InputForm.jsx
 *
 * FB-1 scaffold derived from _ModuleTemplate. This generic row table is
 * replaced in FB-4 (wizard steps) and FB-10 (Phase 2 import flow).
 */
